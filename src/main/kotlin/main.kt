fun main() {
    ...
    val note1 = Note(1, 1, "New", "Первая", 10, 0, 0, "###")
    service.addNote(note1)
    val note2 = Note(1, 1, "2", "Вторая", 15, 0, 0, "###")
    service.addNote(note2)
    val note3 = Note(1, 1, "3", "Третья", 12, 0, 0, "###")
    service.addNote(note3)
    val note4 = Note(1, 1, "4", "Четвертая", 30, 0, 0, "###")
    ...
    val comment4 = Comment(4, 2, 25, "Comment4")
